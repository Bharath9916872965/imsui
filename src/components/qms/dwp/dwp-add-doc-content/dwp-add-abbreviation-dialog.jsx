...
import { addNewAbbreviation, getAbbreviationsByIdNotReq, getDwpRevistionRecordById, updateDwpNotReqAbbreviationIds } from 'services/qms.service';
import './dwp-add-doc-content.component.css';
import AlertConfirmation from '../../../../common/AlertConfirmation.component';


const DwpAddAbbreviationDialog = ({ open, onClose, revisionElements, onConfirm }) => {
    ...
    const submitReqAbbreviation = async () => {
        ...
        if (isConfirmed) {
            ...
            let res = await updateDwpNotReqAbbreviationIds(unSelectedAbbre + '', revisionElements.revisionRecordId + '');
    ...
    const getRevistionRecord = async () => {
        try {
            let revistionRecord = await getDwpRevistionRecordById(revisionElements.revisionRecordId);
...
export default DwpAddAbbreviationDialog;