...
import { amendQm, forwardQm, getLabDetails, getMRList, getMRRepList, getQmVersionRecordDtoList, getSelectedEmpData, revokeSubmit } from "../../../services/qms.service";
...
const QmRevisionRecordsComponent = ({ router }) => {
 ...
 const [initialValues, setInitialValues] = useState({
  ...
  const openTran = (item)=>{
    ...
    window.open('/revision-tran', '_blank');
   }
  ...
  const columns = [
    ...
    { name: 'Description', selector: (row) => row.description, sortable: true, grow: 2, align: 'text-start', width: '19%'  },
    ...
    { name: 'Date Of Revision', selector: (row) => row.issueDate, sortable: true, grow: 2, align: 'text-center',width: '5%' },
    { name: 'Status', selector: (row) => row.status, sortable: false, grow: 2, align: 'text-center',width: '15%' },
    { name: 'Action', selector: (row) => row.action, sortable: false, grow: 2, align: 'text-center',width: '8%' },
  ];
...
const handleSubmitAmmend = async (values) => {
  ...
  console.log('newAmendVersion',newAmendVersion);
  ...
  if (newAmendVersion) {
    ...
    console.log('amendedValues',amendedValues);
    const confirm = await AlertConfirmation({
      ...
      <div className="card-body">
        ...
        {showModal && (
            ...
            <div className="modal fade show" style={{ display: "block" }}>
              <div className="modal-dialog modal-lg modal-lg-custom" style={{ maxWidth: "58%", width: "58%" }}>
                        ...
                        <Form>
                          <div className="row">
                            <div className="col-md-12">
                              ...
                              <div className="col-md-10" style={{ textAlign: "start" }}>
